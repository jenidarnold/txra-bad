					...
					<div class="row">
						...
						<div class="col-md-9 col-sm-9">
							...
							<div class="blog-post-item">
								...
								<h2><a href="{{ url('/news/1') }}">BLOG CAROUSEL POST</a></h2>
								...
								<a href="{{ url('/news/1') }}" class="btn btn-reveal btn-default">
							...
							<div class="blog-post-item">
								...
								<h2><a href="{{ url('/news/1') }}">BLOG IMAGE POST</a></h2>
							...
							<div class="blog-post-item">
								...
								<h2><a href="{{ url('/news/1') }}">BLOG VIDEO POST</a></h2>
							...
							<div class="blog-post-item">
								...
								<h2><a href="{{ url('/news/1') }}">BLOG SOUND CLOUD POST</a></h2>
							...
							<div class="blog-post-item">
								...
								<h2><a href="{{ url('/news/1') }}">BLOG SIMPLE POST</a></h2>
